...
## G사 클라우드 + k사 p친구 + jug(R) + G사 Form(?!?)
### .yellow[서버 + 채팅 플랫폼 + 웹서버 + log용 DB]
...
.pull-center[.ori[![](https://github.com/mrchypark/MSC_apiR/blob/master/docs/img/qrcode_350.png?raw=true)]]
